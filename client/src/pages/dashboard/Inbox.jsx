...
import { useInboxTasks } from '../../hooks/useInboxTasks'; // Import the new hook
import { useTaskSorting } from '../../hooks/useTaskSorting.jsx'; // Import the new hook
...
const InboxPage = () => {
    ...
    const {
        ...
        handleSortChange,
        sortIcon,
        // sortButtonText // Using this for display text
        ...
        <div className="md:ml-72 mt-8 px-4 py-6">
            ...
            <div className="fixed top-0 left-0 right-0 md:left-72 z-10 bg-transparent px-4 py-6 flex items-center justify-between backdrop-blur-md">
                <div className='flex items-center gap-2'>
                    <button className="p-1 rounded-full transition-colors mr-2 block md:hidden" aria-label="Back to Projects">
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        {incompleteTasks.length === 0 && completedTasks.length === 0 ? (
                            <div className="text-[color:var(--color-text)] opacity-50 italic">No tasks in inbox.</div>
                        ) : (
                            <>
